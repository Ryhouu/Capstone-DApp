import { FullValidationSchema, ShortValidationSchema, ValidationSchemaInput, ValidInputTypes } from 'web3-validator/lib/commonjs/types';
...
export declare const abiSchemaToJsonSchema: (abis: ShortValidationSchema | FullValidationSchema, level?: string) => import("web3-validator/lib/commonjs/types").Schema;
export declare const ethAbiToJsonSchema: (abis: ValidationSchemaInput) => import("web3-validator/lib/commonjs/types").Schema;
