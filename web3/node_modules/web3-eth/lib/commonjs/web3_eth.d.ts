...
import { SendTransactionOptions } from 'web3-eth/lib/commonjs/types';
import { LogsSubscription, NewPendingTransactionsSubscription, NewHeadsSubscription, SyncingSubscription } from 'web3-eth/lib/commonjs/web3_subscriptions';
...
export declare class Web3Eth extends Web3Context<Web3EthExecutionAPI, RegisteredSubscription> {
     ...
     * ```
     */
    sendSignedTransaction<ReturnFormat extends DataFormat = typeof DEFAULT_RETURN_FORMAT>(transaction: Bytes, returnFormat?: ReturnFormat, options?: SendTransactionOptions): import("web3-core").Web3PromiEvent<import("web3-types").TransactionReceipt, import("web3-eth/lib/commonjs/types").SendSignedTransactionEvents<ReturnFormat>>;
    /**
