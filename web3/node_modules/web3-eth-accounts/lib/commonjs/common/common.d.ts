...
import type { ConsensusAlgorithm, ConsensusType } from 'web3-eth-accounts/lib/commonjs/common/enums';
import { Chain, CustomChain, Hardfork } from 'web3-eth-accounts/lib/commonjs/common/enums';
import type { BootstrapNodeConfig, CasperConfig, ChainConfig, ChainsConfig, CliqueConfig, CommonOpts, CustomCommonOpts, EthashConfig, GenesisBlockConfig, GethConfigOpts, HardforkConfig } from 'web3-eth-accounts/lib/commonjs/common/types';
/**
